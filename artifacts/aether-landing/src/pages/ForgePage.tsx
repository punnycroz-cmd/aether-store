...
export function ForgePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#07101c' }}>
      ...
      <div className="flex-1 flex flex-col lg:flex-row items-start pt-[64px]" style={{ minHeight: '100svh' }}>

        {/* ── SIDEBAR / CONTROL PANEL ── */}
        <div
          className="w-full lg:w-[clamp(320px,28vw,420px)] lg:h-[calc(100svh-64px)] lg:sticky lg:top-[64px] flex flex-col z-10"
          style={{
